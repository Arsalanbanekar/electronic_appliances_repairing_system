...
<div class="mid_container">
  <div class="our-services">Washing Maching Repair Services</div>
  ...
  <div class="parent-con">
    <div class="vertical2">
      <div class="parafirst2">
        ...
        <h2>Washing Maching Repair Service</h2>
        <br>
        <br>
        <div class="firs_des2">
          <ul id="size">
            <li>
              <h5>All types washing machine repair and service.</h5>

            </li>

            <li>
              <h5>Fully Automatic - Top Load</h5>

            </li>

            <li>
              <h5> Fully Automatic - Front Load</h5>
            </li>
          ...
          <h5 class="washingmc_desc">We provide professional technicians to service all category of washing machines
            same as front-load, top-load, automatic and semi-automatic washing machine. Revamp Services Services
            provides Washing Machine Repair in Pune. We are the best clothes washer repair specialist organization over
            pune area. We can Maintenance of all brands Washing Machine Repair Services in Pimpri, Chinchwad, Wakad,
            Pimple Saudagar, Pimple Gurav, Aundh, Baner, Balewadi, Akurdi, Nigadi, Moshi, Marunji, Hinjawadi, Ravet,
            Punawale, Kiwale, Tathawade, Gahunje, walhekarwadi Pune at your doorstep. Get highly skilled technician,
            reasonable services.

            Schedule An Appointment & For Your Washing Machine, Microwave, Refrigerator, AC Repair Service And
            Maintenance. Get Fast & Reliable Appliance Repair From A Professional.</h5>
    ...
    <div class="img"><img id="welcome" src="./assets/images/washing-machine-repair.jpg"></div>
...
?>
    <meta http-equiv="refresh" content="1; url=http://localhost/admin_panel/washingmc.php" />
<?php
  } else {
